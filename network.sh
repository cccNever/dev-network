...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    docker run --rm -v "$(pwd):/data" busybox sh -c 'cd /data && rm -rf organizations/fabric-ca/org1/admin organizations/fabric-ca/org1/msp organizations/fabric-ca/org1/tls-cert.pem organizations/fabric-ca/org1/ca-cert.pem organizations/fabric-ca/org1/IssuerPublicKey organizations/fabric-ca/org1/IssuerRevocationPublicKey organizations/fabric-ca/org1/fabric-ca-server.db'
    docker run --rm -v "$(pwd):/data" busybox sh -c 'cd /data && rm -rf organizations/fabric-ca/org2/admin organizations/fabric-ca/org2/msp organizations/fabric-ca/org2/tls-cert.pem organizations/fabric-ca/org2/ca-cert.pem organizations/fabric-ca/org2/IssuerPublicKey organizations/fabric-ca/org2/IssuerRevocationPublicKey organizations/fabric-ca/org2/fabric-ca-server.db'
    docker run --rm -v "$(pwd):/data" busybox sh -c 'cd /data && rm -rf organizations/fabric-ca/orderOrg1/admin organizations/fabric-ca/ordererOrg1/msp organizations/fabric-ca/ordererOrg1/tls-cert.pem organizations/fabric-ca/ordererOrg1/ca-cert.pem organizations/fabric-ca/ordererOrg1/IssuerPublicKey organizations/fabric-ca/ordererOrg1/IssuerRevocationPublicKey organizations/fabric-ca/ordererOrg1/fabric-ca-server.db'
    docker run --rm -v "$(pwd):/data" busybox sh -c 'cd /data && rm -rf organizations/fabric-ca/org3/admin organizations/fabric-ca/org3/msp organizations/fabric-ca/org3/tls-cert.pem organizations/fabric-ca/org3/ca-cert.pem organizations/fabric-ca/org3/IssuerPublicKey organizations/fabric-ca/org3/IssuerRevocationPublicKey organizations/fabric-ca/org3/fabric-ca-server.db'
    docker run --rm -v "$(pwd):/data" busybox sh -c 'cd /data && rm -rf organizations/fabric-ca/tls-ca-node1/admin organizations/fabric-ca/tls-ca-node1/msp organizations/fabric-ca/tls-ca-node1/tls-cert.pem organizations/fabric-ca/tls-ca-node1/ca-cert.pem organizations/fabric-ca/tls-ca-node1/IssuerPublicKey organizations/fabric-ca/tls-ca-node1/IssuerRevocationPublicKey organizations/fabric-ca/tls-ca-node1/fabric-ca-server.db'
